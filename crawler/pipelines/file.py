    ...
    def media_downloaded(self, response, request, info):
        ...
        if response.status != 200:
            logger.msg(
                ...
                level=logger.WARNING, spider=info.spider, medianame=self.MEDIA_NAME,
        ...
        logger.msg(
            ...
            level=logger.DEBUG, spider=info.spider, medianame=self.MEDIA_NAME,
        ...
        try:
            ...
            logger.msg(format=whyfmt, level=log.WARNING, spider=info.spider, medianame=self.MEDIA_NAME,
    ...
    def media_to_download(self, request, info):
        def _onsuccess(result):
            ...
            logger.msg(
                ...
                level=logger.DEBUG, spider=info.spider,
        ...
        dfd.addErrback(logger.err, self.__class__.__name__ + '.store.stat_file')
        return dfd
